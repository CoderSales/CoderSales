...
- 🔭 I’m currently working on making a **website** with: **[python](https://www.python.org/)** and **[django](https://www.djangoproject.com/)**. `Nice-to-have's` would be: **[postgreSQL](https://www.postgresql.org/)**, **[React](https://react.dev/)**, and an **[Application Program Interface](https://en.wikipedia.org/wiki/API)** like the **[polygon.io](https://polygon.io/)** for stock market information.
...
- these **Frameworks**: **[django](https://www.djangoproject.com/)**, and [**Bootstrap**](https://getbootstrap.com/), and I would like to learn these JavaScript Frameworks: **[Next]()** and **[React](https://react.dev/)**.
<!-- Here are some lists: -->
